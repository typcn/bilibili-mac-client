...
def main():
    ...
    Danmaku2ASS(args.file, args.file[0].replace("xml","ass"), width, height, args.protect, "Heiti SC", args.fontsize, args.alpha, args.duration_marquee, args.duration_still, args.reduce)
